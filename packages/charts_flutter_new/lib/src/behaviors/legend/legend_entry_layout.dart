...
class SimpleLegendEntryLayout implements LegendEntryLayout {
  ...
  Widget createSymbol(
    ...
    final materialSymbolSize = const Size(12.0, 12.0);
    ...
    final SymbolRendererBuilder symbolRendererBuilder =
        legendEntry.symbolRenderer! is SymbolRendererBuilder
            ...
            : SymbolRendererCanvas(legendEntry.symbolRenderer!, legendEntry.dashPattern);
  ...
  Widget createLabel(
      BuildContext context, common.LegendEntry legendEntry, TappableLegend legend, bool isHidden) {
    final TextStyle style = _convertTextStyle(isHidden, context, legendEntry.textStyle);
  ...
  Widget build(
    ...
    final padding = const EdgeInsets.only(right: 8.0); // Material default.
