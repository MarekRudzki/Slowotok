...
abstract class LegendContentBuilder {
  ...
  Widget build(BuildContext context, common.LegendState legendState, common.Legend legend,
      {bool showMeasures});
}
...
abstract class BaseLegendContentBuilder implements LegendContentBuilder {
  ...
  Widget build(BuildContext context, common.LegendState legendState, common.Legend legend,
    ...
    final entryWidgets = legendState.legendEntries.map((entry) {
      ...
      return legendEntryLayout.build(context, entry, legend as TappableLegend, isHidden,
