...
class Slider<D> extends ChartBehavior<D> {
  ...
  static Set<GestureType> _getDesiredGestures(common.SelectionTrigger eventTrigger) {
    ...
    switch (eventTrigger) {
      ...
      case common.SelectionTrigger.longPressHold:
        ...
        break;
      default:
        throw ArgumentError('Slider does not support the event trigger ' + '"$eventTrigger"');
    }
  ...
  @override
  int get hashCode {
    return Object.hash(eventTrigger, handleRenderer, initialDomainValue, roleId, snapToDatum, style,
        layoutPaintOrder);
  }
}
